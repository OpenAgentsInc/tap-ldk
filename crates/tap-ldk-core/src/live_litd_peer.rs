...
mod tests {
    ...
    fn imported_ldk_node_reports_openagents_rust_lightning_fork() {
        ...
        assert_eq!(
            ...
            "343b86d6031f51f65e67584c97792971ec4260d9"
        );
        assert_eq!(
