...
- `tap-ldk` builds receiver-side artifacts for the Lightning Labs pays
  ...
  durable native receiver balance. The post-success force-close path remains
  open.
