...
- Native restart recovery checkpoints, documented in
  `docs/native-asset-recovery.md`.
- Native cooperative close and proof export smoke, documented in
  `docs/native-asset-close.md`.
