...
1. Finish #57 by replacing the loopback native asset-payment session with the
   ...
   `tap-ldk` sidecar. Keep the completed #81 live settlement report green as a
   regression.
