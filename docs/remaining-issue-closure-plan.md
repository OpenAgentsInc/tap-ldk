...
`1e7b435a015dafb5cc314c135e2eebab18cf460f`, so later issue verification does
...
| Done | #78 Pin forked `ldk-node` to forked `rust-lightning` | `OpenAgentsInc/ldk-node` is pinned to `OpenAgentsInc/rust-lightning@1e7b435a015dafb5cc314c135e2eebab18cf460f`; `tap-ldk` consumes the OpenAgentsInc fork line and reports provenance. | Closed. |
...
| Done | #91 Final simple-taproot negotiation | `OpenAgentsInc/rust-lightning@1e7b435a015dafb5cc314c135e2eebab18cf460f` and `OpenAgentsInc/ldk-node@f803a5e3d0815bedf9250f22ff1045cea974135f` expose final `option_simple_taproot` separately from the staging/`litd` overlay path. | Closed. |
| Done | #92 Splice nonce-map compliance | The same fork line covers current, pending splice, and RBF funding txids in final/multi-funding nonce maps, rejects malformed or reused nonce state, and persists the pending splice plus counterparty nonce map across serialization/reestablish. | Closed; #93 and #94 remain before a production-complete BOLT claim. |
