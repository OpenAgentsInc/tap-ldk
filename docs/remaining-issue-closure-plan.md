...
`4761230b3d8a2732d379087a5510456a13b86c29`, so later issue verification does
...
BIP340 Schnorr, but it still does not reproduce the exact Lightning Labs
Taproot Asset commitment allocation and second-level HTLC transcript. #81
...
| Done | #78 Pin forked `ldk-node` to forked `rust-lightning` | `OpenAgentsInc/ldk-node` is pinned to `OpenAgentsInc/rust-lightning@4761230b3d8a2732d379087a5510456a13b86c29`; `tap-ldk` consumes the OpenAgentsInc fork line and reports provenance. | Closed. |
