...
`0d6ac878453bcc108f315d69aae0bda625c1f871`, so later issue verification does
...
- fork-backed `OpenAgentsInc/ldk-node` peer connection to the independent
  ...
  `OpenAgentsInc/rust-lightning@0d6ac878453bcc108f315d69aae0bda625c1f871`;
...
transaction with static/plain simple-taproot HTLC and change outputs. `litd`
signs dynamically updated Taproot Asset HTLC and change outputs. This issue set
must remain open until Rust Lightning derives those dynamic aux
...
| Done | #78 Pin forked `ldk-node` to forked `rust-lightning` | `OpenAgentsInc/ldk-node` is pinned to `OpenAgentsInc/rust-lightning@0d6ac878453bcc108f315d69aae0bda625c1f871`; `tap-ldk` consumes the OpenAgentsInc fork line and reports provenance. | Closed. |
