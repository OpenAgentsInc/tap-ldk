...
and #58 live gates plus the #59 completion report green as regressions while
the remaining Path B work moves through #60. The rest of the BOLT conformance work is split into the issue set
...
close #60, #71, or #19 from that gate alone. Do not describe #61
