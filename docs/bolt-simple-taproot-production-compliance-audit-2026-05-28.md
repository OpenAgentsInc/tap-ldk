...
#91 and #92 are now implemented. The final `option_simple_taproot` bits are a
...
found while implementing #93 through #94:
...
#95 can close only after #93 and #94 close, `tap-ldk` pins the completed fork
revisions, and the docs no longer describe any first-demo boundary as part of
a production-complete BOLT simple-taproot claim.
