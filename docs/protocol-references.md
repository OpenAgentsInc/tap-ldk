...
| OpenAgentsInc rust-lightning fork | https://github.com/OpenAgentsInc/rust-lightning | owned fork | `ff572b99ff6d` |
| LDK Node upstream | https://github.com/lightningdevkit/ldk-node | `../projects/ldk/repos/ldk-node` | reference |
| OpenAgentsInc ldk-node fork | https://github.com/OpenAgentsInc/ldk-node | owned fork | `001ec96071ec` |
